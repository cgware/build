...
test() {
	...
	gen 08_rdepends_lib "lib/base.a lib/lib1.a lib/lib2.a bin/exe"
	gen 09_rdepends_drv "lib/base.a bin/exe"
	gen 10_exe_dep_lib_drv "lib/lib.a bin/exe"
	gen 11_exe_drv_lib "bin/exe"
	...
	gen 15_platform "bin/15_platform"
	gen 16_example "bin/16_example_example"
	gen 17_hello "exe/bin/hello"
	gen 18_hello_deps "ext/hello/bin/hello"
}
