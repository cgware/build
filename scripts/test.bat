...
:test
	...
	call :gen 08_rdepends "lib/base.lib lib/lib1.lib lib/lib2.lib bin/exe.exe"
	call :gen 09_exe_dep_lib_drv "lib/lib.lib bin/exe.exe"
	call :gen 10_exe_drv_lib "bin/exe.exe"
	...
	call :gen 15_example "bin/15_example_example.exe"
