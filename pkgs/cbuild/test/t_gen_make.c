...
TEST(gen_make_proj_exe)
{
	...
	EXPECT_STRN(tmp.data,
		    ...
		    "\n"
		    "define _exe\n"
		    "$(PN)_$(TN)_$(CONFIG) := $(DIR_OUT_BIN_FILE)\n"
		    "\n"
		    "GCDA_$(CONFIG) += $(PKGSRC_GCDA)\n"
		    "\n"
		    "all: $(PN)_$(TN)_$(CONFIG)/compile\n"
		    "\n"
		    ".PHONY: $(PN)_$(TN)_$(CONFIG)/compile\n"
		    "\n"
		    ...
		    "\n"
		    "define exe\n"
		    "$(foreach c,$(CONFIGS),$(eval $(call _exe,$(c))))\n"
		    "endef\n"
		    "\n"
		    "define _cov\n"
		    "precov_$(CONFIG):\n"
...
TEST(gen_make_proj_lib)
{
	...
	EXPECT_STRN(tmp.data,
		    ...
		    "\n"
		    "define _lib\n"
		    "$(PN)_$(TN)_$(CONFIG) := $(DIR_OUT_LIB_FILE)\n"
		    "\n"
		    "GCDA_$(CONFIG) += $(PKGSRC_GCDA)\n"
		    "\n"
		    "all: $(PN)_$(TN)_$(CONFIG)/compile\n"
		    ...
		    ".PHONY: $(PN)_$(TN)_$(CONFIG)/compile\n"
		    "\n"
		    "$(PN)_$(TN)_$(CONFIG)/compile: $(DIR_OUT_LIB_FILE)\n"
		    "\n"
		    ...
		    "\n"
		    "define lib\n"
		    "$(foreach c,$(CONFIGS),$(eval $(call _lib,$(c))))\n"
		    "endef\n"
		    "\n"
		    "define _cov\n"
		    "precov_$(CONFIG):\n"
...
TEST(gen_make_proj_ext)
{
	...
	EXPECT_STRN(tmp.data,
		    ...
		    "\n"
		    "define _ext\n"
		    "$(PN)_$(TN)_$(CONFIG) := $(DIR_OUT_EXT_FILE)\n"
		    "\n"
		    "all: $(PN)_$(TN)_$(CONFIG)/compile\n"
		    "\n"
		    ".PHONY: $(PN)_$(TN)_$(CONFIG)/compile\n"
		    "\n"
		    "$(PN)_$(TN)_$(CONFIG)/compile: $(DIR_OUT_EXT_FILE)\n"
		    "\n"
		    ...
		    "\n"
		    "define ext\n"
		    "$(foreach c,$(CONFIGS),$(eval $(call _ext,$(c))))\n"
		    "endef\n"
		    "\n"
		    "define _cov\n"
		    "precov_$(CONFIG):\n"
...
TEST(gen_make_proj_test)
{
	...
	EXPECT_STRN(tmp.data,
		    ...
		    "\n"
		    "define _test\n"
		    "$(PN)_$(TN)_$(CONFIG) := $(DIR_OUT_TST_FILE)\n"
		    "\n"
		    "GCDA_$(CONFIG) += $(PKGTST_GCDA)\n"
		    "\n"
		    "all: $(PN)_$(TN)_$(CONFIG)/compile\n"
		    "\n"
		    "test: $(PN)_$(TN)_$(CONFIG)/test\n"
		    "\n"
		    "cov_$(CONFIG): $(PN)_$(TN)_$(CONFIG)/cov\n"
		    "\n"
		    ".PHONY: $(PN)_$(TN)_$(CONFIG)/compile $(PN)_$(TN)_$(CONFIG)/test $(PN)_$(TN)_$(CONFIG)/cov\n"
		    "\n"
		    "$(PN)_$(TN)_$(CONFIG)/compile: $(DIR_OUT_TST_FILE)\n"
		    "\n"
		    "$(PN)_$(TN)_$(CONFIG)/test: $(DIR_OUT_TST_FILE)\n"
		    "\t$(DIR_OUT_TST_FILE)\n"
		    "\n"
		    ...
		    "	@mkdir -pv $$(@D)\n"
		    "	$(TCC) -m$(BITS) -c $(DIR_PKG_TST:%=-I%) $($(PN)_$(TN)_INCLUDES:%=-I%) $(CFLAGS) $(CFLAGS_$(CONFIG)) -o $$@ $$<\n"
		    "\n"
		    "endef\n"
		    "\n"
		    "define test\n"
		    "$(foreach c,$(CONFIGS),$(eval $(call _test,$(c))))\n"
		    "endef\n"
		    "\n"
		    "define _cov\n"
		    "precov_$(CONFIG):\n"
