...
TEST(gen_cmake_proj_unknown)
{
	...
	EXPECT_STRN(tmp.data,
		    ...
		    "set(DIR_OUT_INT_DRV \"${DIR_OUT_INT}${PN}/drivers/\")\n"
...
TEST(gen_cmake_proj_ext)
{
	...
	EXPECT_STRN(tmp.data,
		    ...
		    "\tCOMMAND ${CMAKE_COMMAND} -E copy ${EXT_DIR}${URI_ROOT}${OUT} ${PROJDIR}/bin/${ARCH}-${CONFIG}/ext/${PN}/\n"
		    ")\n"
		    "set_target_properties(${PN}_${TN} PROPERTIES\n"
		    "\tOUTPUT_NAME \"${PN}\"\n"
		    ")\n",
...
TEST(gen_cmake_pkg_exe)
{
	...
	EXPECT_STRN(tmp.data,
		    ...
		    "set_target_properties(${PN}_${TN} PROPERTIES\n"
		    "\tOUTPUT_NAME \"${PN}\"\n"
		    "\tRUNTIME_OUTPUT_DIRECTORY ${PROJDIR}bin/${ARCH}-Debug/bin/\n"
		    "\tRUNTIME_OUTPUT_DIRECTORY_DEBUG ${PROJDIR}bin/${ARCH}-Debug/bin/\n"
		    "\tRUNTIME_OUTPUT_DIRECTORY_RELEASE ${PROJDIR}bin/${ARCH}-Release/bin/\n"
		    ")\n",
		    tmp.len);
...
TEST(gen_cmake_pkg_lib)
{
	...
	EXPECT_STRN(tmp.data,
		    ...
		    "set_target_properties(${PN}_${TN} PROPERTIES\n"
		    "\tOUTPUT_NAME \"${PN}\"\n"
		    "\tARCHIVE_OUTPUT_DIRECTORY ${PROJDIR}bin/${ARCH}-Debug/lib/\n"
		    "\tARCHIVE_OUTPUT_DIRECTORY_DEBUG ${PROJDIR}bin/${ARCH}-Debug/lib/\n"
		    "\tARCHIVE_OUTPUT_DIRECTORY_RELEASE ${PROJDIR}bin/${ARCH}-Release/lib/\n"
		    "\tPREFIX \"\"\n"
		    ")\n",
		    tmp.len);
...
TEST(gen_cmake_pkg_lib_test)
{
	...
	EXPECT_STRN(tmp.data,
		    ...
		    "set_target_properties(${PN}_${TN} PROPERTIES\n"
		    "\tOUTPUT_NAME \"${PN}\"\n"
		    "\tRUNTIME_OUTPUT_DIRECTORY ${PROJDIR}bin/${ARCH}-Debug/test/\n"
		    "\tRUNTIME_OUTPUT_DIRECTORY_DEBUG ${PROJDIR}bin/${ARCH}-Debug/test/\n"
		    "\tRUNTIME_OUTPUT_DIRECTORY_RELEASE ${PROJDIR}bin/${ARCH}-Release/test/\n"
		    ")\n",
		    tmp.len);
