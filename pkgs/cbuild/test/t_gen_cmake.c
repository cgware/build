...
TEST(gen_cmake_proj_build_dir)
{
	...
	EXPECT_STRN(tmp.data,
		    ...
		    "\t\tCOMMAND ${CMAKE_CTEST_COMMAND} --test-dir ${TEST_DIR} -C ${CONFIG}\n"
...
TEST(gen_cmake_proj_test)
{
	...
	EXPECT_STRN(tmp.data,
		    ...
		    "endif()\n"
		    "target_link_libraries(${PN}_${TN} PRIVATE)\n"
		    "add_test(${PN}_${TN}_build ${CMAKE_COMMAND} --build ${CMAKE_BINARY_DIR} --config ${CMAKE_BUILD_TYPE} --target ${PN}_${TN})\n"
