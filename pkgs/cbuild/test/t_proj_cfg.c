...
TEST(proj_cfg_null)
{
	...
	EXPECT_EQ(proj_cfg(NULL, NULL, 0, NULL, NULL, STRV_NULL, STRV_NULL, NULL), 1);
...
TEST(proj_cfg_empty)
{
	...
	EXPECT_EQ(proj_cfg(&proj, &cfg, root, NULL, NULL, STRV_NULL, STRV_NULL, NULL), 0);
...
TEST(proj_cfg_pkg_empty)
{
	...
	mem_oom(1);
	EXPECT_EQ(proj_cfg(&proj, &cfg, root, NULL, NULL, STRV_NULL, STRV_NULL, NULL), 1);
	mem_oom(0);
	EXPECT_EQ(proj_cfg(&proj, &cfg, root, NULL, NULL, STRV_NULL, STRV_NULL, NULL), 0);
...
TEST(proj_cfg_pkg_exists)
{
	...
	proj_add_pkg(&proj, STRV("p"), NULL)->inited = 1;
...
TEST(proj_cfg_pkg_dir)
{
	...
	EXPECT_EQ(proj_cfg(&proj, &cfg, root, NULL, NULL, STRV_NULL, STRV("p/"), NULL), 0);
	EXPECT_NE(proj_find_pkg(&proj, STRV("p"), NULL), NULL);
...
TEST(proj_cfg_pkg_src)
{
	...
	EXPECT_EQ(proj_cfg(&proj, &cfg, root, &fs, NULL, STRV_NULL, STRV_NULL, NULL), 0);
	pkg_t *pkg = proj_get_pkg(&proj, 0);
...
STEST(proj_cfg)
{
	...
	RUN(proj_cfg_pkg_exists);
	RUN(proj_cfg_pkg_dir);
	RUN(proj_cfg_pkg_name);
