...
static const svar_t s_vars[__VARS_CNT] = {
	...
	PSVAR(PKG_DLFILE, "${${PN}_DLFILE}"),
	PSVAR(PKG_DLROOT, "${${PN}_DLROOT}"),
	// TGT
	...
	PSVAR(DIR_TMP_EXT_PKG_ROOT, "${DIR_TMP_EXT_PKG}${PKG_DLROOT}"),
	...
	PSVAR(DIR_OUT_INT_DRV, "${DIR_OUT_INT}${PN}/drivers/"),
