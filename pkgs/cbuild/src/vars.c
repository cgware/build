...
static const svar_t s_vars[__VARS_CNT] = {
	...
	PSVAR(PKG_URI_NAME, "${${PN}_URI_NAME}"),
	PSVAR(PKG_URI_ROOT, "${${PN}_URI_ROOT}"),
	// PKG TMP
	PSVAR(DIR_TMP_EXT_PKG, "${DIR_TMP_EXT}${PKG_DIR}"),
	PSVAR(DIR_TMP_EXT_PKG_SRC, "${DIR_TMP_EXT_PKG}${PKG_URI_NAME}-src/"),
	PSVAR(DIR_TMP_EXT_PKG_SRC_ROOT, "${DIR_TMP_EXT_PKG_SRC}${PKG_URI_ROOT}"),
	PSVAR(DIR_TMP_EXT_PKG_BUILD, "${DIR_TMP_EXT_PKG}${PKG_URI_NAME}-build-${ARCH}-${CONFIG}/"),
	// PKG OUT
