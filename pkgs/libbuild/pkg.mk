...
.PHONY: libbuild/test
libbuild/test: $(LIBBUILD_TEST)
	@rm -rf $(LIBBUILD_GCDA) $(LIBBUILD_TEST_GCDA)
	$(LIBBUILD_TEST)

$(LIBBUILD_TEST): $(LIBBUILD_TEST_OBJ) $(LIBBUILD_TEST_LIBS)
	@mkdir -p $(@D)
	$(TCC) -m$(BITS) $(LDFLAGS) -o $@ $(LIBBUILD_TEST_OBJ) -L$(BUILDDIR)bin/$(ARCH)-$(CONFIG)/libs $(patsubst %,-l:%,$(notdir $(LIBBUILD_TEST_LIBS)))
